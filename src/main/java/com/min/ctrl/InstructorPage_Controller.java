...
public class InstructorPage_Controller {

	private static final Logger logger = LoggerFactory.getLogger(InstructorPage_Controller.class);
	...
	public String userPaging(HttpSession session,
		...
		JSONObject json = null;
			...
			rowVo.setTotal(iService.adminInsListTotal());
			json = jsonForm(iService.adminInsListRow(rowVo), rowVo, (MemberVo) mvo); // 현재 index 의 글 start, last, 요청row, 사용자 정보
