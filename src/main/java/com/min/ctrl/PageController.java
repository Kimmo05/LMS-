...
public class PageController {
	...
	public String paging(HttpSession session, RowNumVo rowVo) {
		logger.info("PageController row : {}", session.getAttribute("row"));
		logger.info("PageController rowVo : {}", session.getAttribute("rowVo"));
...
//		}
		...
		logger.info("JSON으로 변환된 글 리스트 :  {}", jList.toString());
