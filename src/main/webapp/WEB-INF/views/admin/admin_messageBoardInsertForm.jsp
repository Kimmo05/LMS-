            ...
            <div class="row">
              <div class="col-sm-12">
				<div class="card">
                  ...
                  <form class="form theme-form" action="./mesBoardInsert.do" method="post">
                    <div class="card-body">
                    <div class="row">
                        <div class="col">
                          <div class="mb-3">
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <input name="mes_recipient" class="form-control" id="exampleInputPassword2" type="text" placeholder="내용을 입력해주세요">
                          </div>
                        </div>
                      </div>
                      <div class="row">
