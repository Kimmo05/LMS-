                ...
                <div class="col-xl-8">
                  <form class="card " >
                    ...
                    <div class="card-footer text-end">
                      <button class="btn btn-primary" type="submit" id="reg_submit">Update Profile</button>
                    </div>
                  </form>
                </div>
              </div>
...
//	 			data:'id='+traId,
			...
			$("#reg_submit").click(function() {
				...
				var brith = $("#birth").val();
				var email = $("#email").val();
				cosonle.log(pw.value,phone.value,brith.value,email.value)
				$.ajax({
		            url : './editUser.do',
		 			data:"pw=" + pw.value + "&phone=" + phone.value+"&birth=" + birth.value+"&email=" + email.value,
					type : 'POST',
					success : function(data) {
						console.log("통과")
