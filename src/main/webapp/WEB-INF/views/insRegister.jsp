        ...
        <div class="row m-0">
          <div class="col-12 p-0">    
            <div class="login-card" >
              <form class="theme-form login-form form-wizard" method="post" action="./InsSingUpSc.do">
                   <div class="tab">
                   <form  id="form__wrap">
                    <h4>강사 회원가입</h4>
                		<h6>LMS</h6>
...
개별 서비스에 대해 별도 수신 동의를 받을 수 있으며, 이때에도 수신 동의에 대해 별도로 안내하고 동의를 받습니다.
               ...
               <div class="row">
                ...
                <label>은행</label>
                  <div class="small-group">
                    ...
                    <div class="input-group"><span class="input-group-text"><i class="icon-user"></i></span>
                      <input class="form-control digits" type="test" name="banknum" id="banknum" maxlength='13' required="" placeholder=" &quot; - &quot;  제외입력">
                    </div>
  ...
  $(".checkbox_group").on("click", ".normal", function() {
	...
	$("#id").blur(function() {
		...
		$.ajax({
// 			url : './CheckTraId.do',
            url : '${pageContext.request.contextPath}/ins/CheckInsId.do?id='+ InsId,
// 			data:'id='+traId,
			type : 'get',
